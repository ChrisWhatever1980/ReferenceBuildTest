========================================================================
    DYNAMIC LINK LIBRARY: WindowsProjectTools-Projektübersicht
========================================================================

Diese WindowsProjectTools-DLL wurde vom Anwendungs-Assistenten für Sie 
erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre WindowsProjectTools-Anwendung besteht.

WindowsProjectTools.vcxproj
...
WindowsProjectTools.vcxproj.filters
...
WindowsProjectTools.cpp
    Dies ist die Hauptquelldatei der DLL.

WindowsProjectTools.h
