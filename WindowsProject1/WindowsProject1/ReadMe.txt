================================================================================
 MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: WindowsProject1-Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese WindowsProject1-Anwendung für Sie 
...
finden, aus denen Ihre WindowsProject1–Anwendung besteht.
...
WindowsProject1.h
    ...
    die CWindowsProject1App-Anwendungsklasse.

WindowsProject1.cpp
    Dies ist die Hauptquelldatei der Anwendung, die die CWindowsProject1App-
...
res\WindowsProject1.ico
    Dies ist eine Symboldatei, die als Symbol der Anwendung verwendet wird. 
    Dieses Symbol ist in der Hauptressourcendatei "WindowsProject1.rc" 
    enthalten.

res\WindowsProject1.rc2
...
WindowsProject1Doc.h, WindowsProject1Doc.cpp – das Dokument
    Diese Dateien enthalten Ihre CWindowsProject1Doc–Klasse. Bearbeiten Sie 
    diese Dateien, um spezielle Dokumentdaten hinzuzufügen und Dateispeicherung
    und –ladung (über CWindowsProject1Doc::Serialize) zu implementieren.

WindowsProject1View.h, WindowsProject1View.cpp – die Ansicht des Dokuments
    Diese Dateien enthalten Ihre CWindowsProject1View–Klasse.
    CWindowsProject1View-Objekte werden verwendet, um CWindowsProject1Doc-
    Objekte anzuzeigen.

res\WindowsProject1Doc.ico
    Dies ist eine Symboldatei, die als Symbol für untergeordnete MDI-Fenster
    für die CWindowsProject1Doc-Klasse verwendet wird. Dieses Symbol ist in der 
    Hauptressourcendatei "WindowsProject1.rc" enthalten.
...
"StdAfx.h", "StdAfx.cpp"
    ...
    (PCH-Datei) mit dem Namen "WindowsProject1.pch.pch2 und eine 
