...
// WindowsProject1.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CWindowsProject1App, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CWindowsProject1App::OnAppAbout)
...
// CWindowsProject1App-Erstellung

CWindowsProject1App::CWindowsProject1App()
{
	...
	SetAppID(_T("WindowsProject1.AppID.NoVersion"));

	// TODO: Hier Code zur Konstruktion einfügen
	// Alle wichtigen Initialisierungen in InitInstance positionieren
}

// Das einzige CWindowsProject1App-Objekt

CWindowsProject1App theApp;


// CWindowsProject1App-Initialisierung

BOOL CWindowsProject1App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_WindowsProject1TYPE,
		RUNTIME_CLASS(CWindowsProject1Doc),
		RUNTIME_CLASS(CChildFrame), // Benutzerspezifischer MDI-Child-Rahmen
		RUNTIME_CLASS(CWindowsProject1View));
	if (!pDocTemplate)
		return FALSE;
...
int CWindowsProject1App::ExitInstance()
{
...
// CWindowsProject1App-Meldungshandler
...
void CWindowsProject1App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CWindowsProject1App Methoden zum Laden/Speichern von Anpassungen

void CWindowsProject1App::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CWindowsProject1App::LoadCustomState()
{
}

void CWindowsProject1App::SaveCustomState()
{
}
